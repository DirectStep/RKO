...
const applicationLabels = { questionnaire_completed:'Анкета заполнена',banks_selected:'Банки выбраны',opening_accounts:'Оформление счетов',activating_accounts:'Активация счетов',completed:'Завершена' }
