START_TEXT = (
    ...
    "Ответь на несколько коротких вопросов. После отправки заявки с тобой свяжется менеджер."
)

CONSENT_PROMPT = (
    "Чтобы создать заявку, нужно твоё согласие на обработку "
    "персональных данных. Ты можешь сначала прочитать текст согласия."
)
