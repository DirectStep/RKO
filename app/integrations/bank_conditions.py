...
BANK_ALIASES = {
    "ак барс банк": ("Акбарс Банк", "Акбарс"),
    "альфа-банк": (
        "Альфа-Банк (ИП+счёт)",
        "Альфа-Банк (без открытия ИП)",
        "Альфа (ИП+РКО) +5к лиду бонусами сама альфа платит",
        "Альфа счёт (без открытия ИП в Альфе)",
    ),
    "банк санкт-петербург": ("Банк Санкт-Петербург", "БСПБ (гео маленькое)"),
    "ozon банк": ("Озон", "Озон (можно онлайн даже без КЭП)"),
}
