...
function openPartner(id){
  ...
  document.querySelector('#partner-commission').value='20'
  document.querySelector('#partner-commission').disabled=true
  document.querySelector('#save-commission').hidden=true
...
function openNewPartner(){
  ...
  document.querySelector('#new-partner-percent').disabled=true
