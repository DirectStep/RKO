...
function bankCard(item,employee,admin,quickActions){
  ...
  const confirm=admin&&item.lead_reward_paid_at&&item.payment_status==='awaiting_confirmation'?`<button class="primary-button" data-confirm-pay="${item.id}">Подтвердить выплату</button>`:''
